...
(function () {
  ...
  const i18n = {
    bn: {
      ...
      fullName: 'পুরো নাম',
      fullNamePlaceholder: 'যেমন: ফাহমিদা মুন',
      phone: 'মোবাইল নম্বর',
      ...
      checkoutComplianceNotice: 'অর্ডার সম্পন্ন করার মাধ্যমে আপনি আমাদের <a href="terms.html" class="underline hover:text-[#166b58] dark:hover:text-yellow-400 font-semibold">ব্যবহারের শর্তাবলী</a> এবং <a href="privacy.html" class="underline hover:text-[#166b58] dark:hover:text-yellow-400 font-semibold">গোপনীয়তা নীতিতে</a> সম্মতি দিচ্ছেন।',
    ...
    en: {
      ...
      checkoutComplianceNotice: 'By placing this order, you agree to our <a href="terms.html" class="underline hover:text-[#166b58] dark:hover:text-yellow-400 font-semibold">Terms of Service</a> and <a href="privacy.html" class="underline hover:text-[#166b58] dark:hover:text-yellow-400 font-semibold">Privacy Policy</a>.',
