/**
 * ============================================================================
 * PAKU (পাঁকু) ASSISTANT — STANDALONE INTERACTIVE WEB COMPONENT
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    if (!document.querySelector('paku-assistant')) {
      const pakuEl = document.createElement('paku-assistant');
      document.body.appendChild(pakuEl);
    }
  });
